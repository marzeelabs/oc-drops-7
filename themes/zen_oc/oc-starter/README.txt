...
Copy this theme to site/all/themes, rename the theme and enable it.
It will use zen-oc as a base theme if it's located under sites/all/themes/zen_oc/zen-oc


README FROM ZEN BELOW
----------------------
